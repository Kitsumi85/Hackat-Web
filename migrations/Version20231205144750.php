 ...
 */
final class Version20231205144750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conference (id INT NOT NULL, un_intervenant_id INT DEFAULT NULL, theme VARCHAR(255) NOT NULL, INDEX IDX_911533C8E006E110 (un_intervenant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, un_hackaton_id INT NOT NULL, descrription VARCHAR(255) NOT NULL, date DATE NOT NULL, heure TIME DEFAULT NULL, durée VARCHAR(255) DEFAULT NULL, salle VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_B26681EDD39DACB (un_hackaton_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE hackaton (id INT AUTO_INCREMENT NOT NULL, nbr_places_limit INT DEFAULT NULL, date_lim_insc DATE NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, lieu VARCHAR(255) NOT NULL, heure TIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE atelier ADD CONSTRAINT FK_E1BB1823BF396750 FOREIGN KEY (id) REFERENCES evenement (id) ON DELETE CASCADE');
